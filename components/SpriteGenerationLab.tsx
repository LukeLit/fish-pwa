...
interface SpriteGenerationLabProps {
  ...
  /** When true, renders inline without modal wrapper (for use in tabs) */
  embedded?: boolean;
}
...
export default function SpriteGenerationLab({
  ...
  return (
    <div className={outerClassName} style={embedded ? undefined : { zIndex: Z_LAYERS.MODAL }}>
      <div className={innerClassName}>
        ...
        {/* Content */}
        <div className={`flex-1 overflow-y-auto ${embedded ? 'p-4 space-y-4' : 'p-6 space-y-6'}`}>
          {/* Error display */}
          {error && (
